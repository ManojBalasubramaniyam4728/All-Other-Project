...
public class Enabled {
	...
	demo.click();
	wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//button[text()='+ Module']"))));
	WebElement ModuleButton =driver.findElement(By.xpath("//button[text()='+ Module']"));
	System.out.println(ModuleButton.isEnabled());
